...
- (void)headBtnClick
{
    _contactGroup.opened = !_contactGroup.isOpened;
...
- (void)setContactGroup:(ContactGroup *)contactGroup
{
    ...
    [_bgButton setTitle:contactGroup.groupName forState:UIControlStateNormal];
    _numLabel.text = [NSString stringWithFormat:@"%zd", contactGroup.contacts.count];
}

- (void)didMoveToSuperview
{
    _bgButton.imageView.transform = _contactGroup.isOpened ? CGAffineTransformMakeRotation(M_PI_2) : CGAffineTransformMakeRotation(0);
}
